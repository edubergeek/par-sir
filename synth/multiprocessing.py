...
class Iterator(object):
    ...
    def nonmpi_work(self, rangex, rangey):
        ...
        self.stokes_db = self.f_stokes_out.create_dataset('stokes', (self.model.ny, self.model.nx, 4, self.model.n_lambda_sir))
        ...
        with tqdm(total=self.n_batches, ncols=140) as pbar:            
            while (closed_workers < num_workers):
                ...
                if tag == tags.READY:
                    ...
                    for i in range(len(indX)):
                        self.stokes_db[indY[i],indX[i],:,:] = stokes[1:,i,:]
