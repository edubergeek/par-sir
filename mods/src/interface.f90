...
! contamos el numero de puntos	
	...
	character(len=2), dimension(92) :: atom_name = (/'H ','HE','LI','BE','B ','C ','N ','O ','F ','NE',&
     ...
     'FR','RA','AC','TH','PA','U '/)
        ...
        real(kind=4), dimension(92) :: eps=(/12.0,11.0,0.60,1.35,-8.0,8.55,7.93,8.77,&
        	5.40,8.51,6.18,7.48,6.40,7.55,5.51,7.21,5.40,6.62,5.05,6.33,3.20,4.28,3.66,&
        	5.47,4.88,7.50,4.30,5.08,3.88,3.98,2.31,2.43,-8.0,-8.0,-8.0,-8.0,2.81,3.08,&
        	2.80,2.38,1.98,2.08,-8.0,1.75,1.73,1.78,0.85,2.05,1.69,-8.0,0.93,-8.0,-8.0,&
        	-8.0,2.38,2.88,1.68,1.71,0.77,1.91,-8.0,1.18,1.14,1.31,1.47,0.53,1.61,1.98,&
        	1.31,1.99,1.29,1.13,1.98,1.33,2.13,1.63,2.43,1.93,0.50,1.98,-8.0,1.98,1.63,&
        	-8.0,-8.0,-8.0,-8.0,-8.0,-8.0,1.21,-8.0,1.48/)
